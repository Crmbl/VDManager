...
namespace VDManager.Utils
{
    ...
    public static class DependencyInjectionUtil
    {
        ...
        /// The 
        /// </summary>
        private static readonly IUnityContainer s_Container;
        ...
        public static void Register<TFrom, TTo>(Func<TTo> createMethod) where TTo : TFrom
        {
        ...
        /// <param name="instance"></param>
        public static void RegisterInstance<T>(string identifier, T instance) where T : class
        {
