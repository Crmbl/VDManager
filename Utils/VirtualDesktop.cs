    ...
    public static class VirtualDesktop
    {
        ...
        public static void GoLeft()
        {
            ...
            { // activate virtual desktop to the left
                if (wrapdesktops && (Desktop.FromDesktop(Desktop.Current) == 0))
        ...
        public static void GoRight()
        {
            ...
            { // activate virtual desktop to the right
                if (wrapdesktops && (Desktop.FromDesktop(Desktop.Current) == Desktop.Count - 1))
        ...
        { // retrieve main window handle to process name
            ...
            {
                processList.Add((int)process.MainWindowHandle);
            }
        ...
        private static bool EnumWindowsProcToList(IntPtr hWnd, int lParam)
        {
            try
            {
                int iDesktopIndex = Desktop.FromDesktop(Desktop.FromWindow(hWnd));
        ...
        private static bool EnumWindowsProcToMoveWindows(IntPtr hWnd, int lParam)
        {
            ...
            {
                int iDesktopIndex = Desktop.FromDesktop(Desktop.FromWindow(hWnd));
                if (iDesktopIndex == iMoveWindowsDesktop1) Desktop.FromIndex(iMoveWindowsDesktop2).MoveWindow(hWnd);
            }
            catch { }
        ...
        private static bool EnumWindowsProcToSwap(IntPtr hWnd, int lParam)
        {
            ...
            if (!string.IsNullOrEmpty(title) && IsWindowVisible(hWnd))
            {
                ...
                {
                    int iDesktopIndex = Desktop.FromDesktop(Desktop.FromWindow(hWnd));
                    if (iDesktopIndex == iSwapDesktop1) Desktop.FromIndex(iSwapDesktop2).MoveWindow(hWnd);
                    if (iDesktopIndex == iSwapDesktop2) Desktop.FromIndex(iSwapDesktop1).MoveWindow(hWnd);
                }
                catch { }
            }
        ...
        private static void SwapDesktops(int SwapIndex1, int SwapIndex2)
        {
            ...
            string desktopname1 = "";
            if (Desktop.HasDesktopNameFromIndex(iSwapDesktop1))
                desktopname1 = Desktop.DesktopNameFromIndex(iSwapDesktop1);
            string desktopname2 = "";
            if (Desktop.HasDesktopNameFromIndex(iSwapDesktop2))
                desktopname2 = Desktop.DesktopNameFromIndex(iSwapDesktop2);
